...
export const BRANDING_TYPOGRAPHY_PRESET_LABELS: Record<BrandingTypographyPresetId, string> = {
  arulneri: "Arul Neri default",
  modern: "Modern",
  classic: "Classic",
  "tamil-first": "Tamil-first",
};
...
export function scaleFromBaseMd(md: number): BrandingTypography["scale"] {
